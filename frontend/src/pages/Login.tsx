    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-2">Авторизуйтесь в аккаунте</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-600 dark:text-gray-300">
          Нет аккаунта?{' '}
          <a href="/register" className="font-semibold bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent hover:from-blue-700 hover:to-purple-700">
            Зарегистрироваться
          </a>
        </p>
      </div>
